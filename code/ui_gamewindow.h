...
public:
    ...
    QHBoxLayout *gameOverDisasterTypeHorizontalLayout;
    QLabel *gameOverDisasterLabel;
    QLabel *gameOverDisasterImageLabel;
...
"}"));
        ...
        horizontalLayoutWidget->setGeometry(QRect(20, 460, 241, 51));
        gameOverDisasterTypeHorizontalLayout = new QHBoxLayout(horizontalLayoutWidget);
        gameOverDisasterTypeHorizontalLayout->setObjectName("gameOverDisasterTypeHorizontalLayout");
        gameOverDisasterTypeHorizontalLayout->setContentsMargins(0, 0, 0, 0);
        gameOverDisasterLabel = new QLabel(horizontalLayoutWidget);
...
"}"));
        ...
        gameOverDisasterImageLabel = new QLabel(horizontalLayoutWidget);
        gameOverDisasterImageLabel->setObjectName("gameOverDisasterImageLabel");

        gameOverDisasterTypeHorizontalLayout->addWidget(gameOverDisasterImageLabel);
    ...
    void retranslateUi(QDialog *GameWindow)
    {
        ...
        gameOverDisasterLabel->setText(QCoreApplication::translate("GameWindow", "Disaster", nullptr));
        gameOverDisasterImageLabel->setText(QString());
    } // retranslateUi
