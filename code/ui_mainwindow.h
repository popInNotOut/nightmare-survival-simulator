...
"}"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        rigorousTestingDescriptionLabel->setText(QCoreApplication::translate("MainWindow", "Enemies spawn randomly on the edge of the map. When a disaster dies out, a new disaster of the same type will spawn on the edge of the map. A robber is guaranteed to never attack a terrorist and vice versa. If a robber touches you before all blocks are destroyed, he will swap locations instead of attack.", nullptr));
